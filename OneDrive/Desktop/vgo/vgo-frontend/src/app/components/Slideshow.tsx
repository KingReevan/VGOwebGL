  ...
  return (
    <section className="relative py-16 overflow-hidden">
      ...
      <div className="relative w-full max-w-6xl mx-auto h-[500px]">
        ...
        <button
          onClick={prev}
          className="absolute left-4 top-1/2 -translate-y-1/2 z-50 p-3 rounded-full bg-white/90 border shadow-md hover:bg-white text-black transition-all cursor-pointer"
        >
          <ChevronLeft size={24} />
        </button>
        <button
          onClick={next}
          className="absolute right-4 top-1/2 -translate-y-1/2 z-50 p-3 rounded-full bg-white/90 border shadow-md hover:bg-white text-black transition-all cursor-pointer"
        >
