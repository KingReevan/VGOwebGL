...
export default function Footer() {
  return (
    <footer className="w-full bg-gray-900 text-gray-300 selection:bg-red-500">
      <div className="py-10">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto px-4">
          {/* Policies & Legal */}
          ...
          {/* Offers */}
          <div className="space-y-3">
            <h3 className="text-white font-bold text-lg">Special Offers</h3>
            <ul className="space-y-2">
              <li><Link href="/offers/student-discount" className="hover:text-white">Student Discount (20% Off)</Link></li>
              <li><Link href="/offers/weekend-special" className="hover:text-white">Weekend Special Package</Link></li>
              <li><Link href="/offers/corporate" className="hover:text-white">Corporate Group Rates</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/app" className="hover:text-white">Download Our App</Link></li>
        ...
        {/* Bottom Footer */}
        <div className="flex flex-col gap-y-6 md:flex-row justify-between items-center max-w-6xl mx-auto px-4">
