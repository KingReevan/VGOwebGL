...
export default function CarAndTrackDetails() {
  return (
    <section className="space-y-12 px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div>
            {/* Go-Kart Section */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:grid-cols-2 lg:grid-cols-3 items-center grid-flow-row-dense">

                {/* Image - Mobile first order */}
                <div className="order-2 lg:order-1 relative aspect-video w-full rounded-xl overflow-hidden shadow-[0_0_15px_2px_rgba(255,0,0,0.4)] border border-red-500 col-span-1 sm:col-span-2">
                <Image 
                    src="/hero-bg.jpeg" 
                ...
                <div className="order-1 flex flex-col items-center md:order-2 space-y-4 lg:order-3 row-span-1 lg:row-span-2 h-full shadow-[0_0_15px_2px_rgba(255,0,0,0.4)] border border-red-500 rounded-xl pt-4 bg-gradient-to-t from-red-500/60 from-1%">
                ...
                {/* Text Content - Mobile first order */}
                <div className="order-5 flex flex-col items-center space-y-4 lg:space-y-6 row-span-1 lg:row-span-2 lg:order-3 h-full shadow-[0_0_15px_2px_rgba(255,0,0,0.4)] border border-red-500 rounded-xl bg-gradient-to-b from-red-500/60 from-1%">
                ...
                <div className="order-3 lg:order-4 shadow-[0_0_15px_2px_rgba(255,0,0,0.4)] border border-red-500 rounded-xl py-2">
                ...
                {/* Image - Mobile first order */}
                <div className="order-4 relative aspect-video w-full rounded-xl overflow-hidden shadow-[0_0_15px_2px_rgba(255,0,0,0.4)] border border-red-500 col-span-1 sm:col-span-2 lg:order-5">
                <Image 
                    src="/asianRacer.webp" 
