  ...
  return (
    <section className="py-12 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className={`bg-gray-800 backdrop-blur-sm rounded-xl overflow-hidden 
          shadow-[0_0_15px_2px_rgba(255,0,0,0.4)] border border-red-500`}>
          ...
          {showViewAll && (
            <div className="p-0 text-center">
              <Button variant="outline" className="border-red-500 bg-gradient-to-bl from-red-500 to-rose-950 text-primary w-full h-12 rounded-none hover:text-primary hover:scale-110 cursor-pointer hover:from-50%">
